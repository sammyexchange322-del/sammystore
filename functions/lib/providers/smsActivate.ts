...
const COUNTRY_MAP: Record<string, string> = {
  us:'12',gb:'16',ca:'1',au:'9',de:'2',fr:'78',it:'5',es:'4',nl:'10',se:'26',
  no:'30',ch:'73',be:'11',pl:'15',cz:'86',tr:'52',in:'22',pk:'44',bd:'36',
  id:'6',my:'7',sg:'14',jp:'13',kr:'51',th:'52',vn:'99',br:'73',mx:'41',
  za:'84',ua:'1',ru:'0',ph:'73',ng:'95',
};
const SERVICE_MAP: Record<string, string> = {
  whatsapp:'wa',telegram:'tg',instagram:'ig',facebook:'fb',tiktok:'tk',
  google:'go',gmail:'gm',discord:'ds',amazon:'am',netflix:'nf',paypal:'pp',
  binance:'bn',twitter:'tw',linkedin:'li',snapchat:'sc',steam:'st',uber:'ub',
  microsoft:'ms',apple:'ap',yahoo:'ya',line:'ln',wechat:'wc',coinbase:'cb',spotify:'sp',
};
export class SmsActivateProvider implements IProvider {
  slug='sms_activate'; name='SMS-Activate';
  ...
  async buyNumber(countryCode:string,serviceSlug:string):Promise<NumberOrder>{
    ...
    if(parts[0]!=='ACCESS_NUMBER')throw new Error(`SMS-Activate: ${res}`);
    return{providerOrderId:parts[1],phoneNumber:parts[2]};
  }
  async checkSms(id:string):Promise<SmsMessage|null>{
    const res=await this.call({action:'getStatus',id});
  ...
  async cancelOrder(id:string):Promise<void>{await this.call({action:'setStatus',id,status:'8'});}
  async getBalance():Promise<number>{const res=await this.call({action:'getBalance'});return parseFloat(res.split(':')[1]??'0');}
}
