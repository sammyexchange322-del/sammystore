  ...
  return (
    <div className="max-w-md space-y-5">
      <div className="space-y-2">
        <label className="text-sm font-medium text-brand-navy">USD → NGN Exchange Rate</label>
        <div className="flex items-center gap-2">
          ...
          <input type="number" value={exchangeRate} onChange={e => setExchangeRate(e.target.value)}
            className="flex-1 px-3 py-2 rounded-lg border border-border bg-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-orange/30" />
          <span className="text-muted-foreground text-sm">₦</span>
        </div>
      </div>
      <div className="space-y-2">
        <label className="text-sm font-medium text-brand-navy">Default Margin (%)</label>
        <div className="flex items-center gap-2">
      ...
      <button onClick={save} disabled={saving}
        className="flex items-center gap-2 px-4 py-2.5 bg-brand-orange text-white rounded-lg text-sm font-medium hover:bg-brand-orange-hover disabled:opacity-50 transition-all">
      ...
      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
        <div className="flex gap-2">
          ...
          <p className="text-xs text-yellow-700">
            ...
            <code className="block mt-1">SMS_ACTIVATE_API_KEY</code>
            <code className="block">FIVE_SIM_API_KEY</code>
          </p>
        </div>
      </div>
    </div>
